...
(* OASIS_START *)
(* DO NOT EDIT (digest: 8c376fb9bb6c4151cc2053dc822e330d) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Pierre-Malo Deni\195\169lou"];
          homepage =
            Some "http://www.ct.info.gifu-u.ac.jp/~keigoi/session-ocaml/";
          bugreports = None;
          synopsis =
            "A concurrent / distributed programming with protocol typing,\nbased on Session Types.";
          description = None;
          tags = [];
          categories = [];
          files_ab = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Scribble"; "ScribbleSyntax"];
                      lib_pack = false;
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "src";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "scribble"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                           {
                   ...
                   {exec_custom = false; exec_main_is = "oscribble.ml"})
            ];
     ...
     oasis_version = "0.4.7";
     oasis_digest = Some "3nM\021f\133P7m\208\131\153\180\208\031\190";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
